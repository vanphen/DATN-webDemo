				      		...
				      		<div class="form-group">				      			
				      			<div class="row">
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				...
					      				Ảnh cũ: <img src="{{ asset('uploads/products/'.$pro->images)}}" alt="{!!$pro->images}}" width="80" height="60">
					      			</div>
				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">
					      			@foreach($pro->detail_img as $row)
					      				<?php $stt++; ?>
					      				<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">						 
						      				Ảnh cũ: {!!$stt}}<img src="{{ asset('uploads/products/details/'.$row->images_url)}}" alt="{!!$row->images_url}}" width="80" height="60">
						      			</div>
					      			@endforeach
					      		</div>
					      		<div class="row">
