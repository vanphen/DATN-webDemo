...
@section('content')
    ...
    <h3 class="panel-title">
      <span class="glyphicon glyphicon-home"><a href="{{ asset('/')}}" title=""> Home</a></span> 
      <span class="glyphicon glyphicon-chevron-right" style="font-size: 11px;"></span><a href="{{ asset('/mobile')}}" title=""> Điện thoại</a>
            ...
            <div class="panel-body">
              ...
              <!-- hot new content -->
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                  <h3 class="pro-detail-title"><a href="{{ asset('/mobile/'.$data->id.'-'.$data->slug)}}" title="">{!!$data->name}}</a></h3>
                  <hr>
                  <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                      <div class="img-box">
                        <img class="img-responsive img-mobile" src="{{ asset('uploads/products/'.$data->images)}}" alt="img responsive">
                      </div>
                      <div class="img-slide">
                        <div class="panel panel-default text-center">        
                          <div id="links">
                            @foreach($data->detail_img as $row)
                              <a href="{{ asset('uploads/products/details/'.$row->images_url)}}" title="{!!$data->name}}" data-gallery>
                                  <img src="{{ asset('uploads/products/details/'.$row->images_url)}}" alt="{!!$data->name}}" width="30" height="40">
                              </a>
                            @endforeach                              
                          </div>
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                      ...
                      @if($data->status ==1)
                        <a href="{{ asset('gio-hang/addcart/'.$data->id)}}" title="" class="btn btn-large btn-block btn-primary" style="font-size: 20px;">Đặt hàng ngay</a>
                      @else
