...
@section('content')
    ...
    <h3 class="panel-title">
      ...
      <span class="glyphicon glyphicon-chevron-right" style="font-size: 11px;"></span><a href="{{ asset('/laptop')}}" title=""> Laptop</a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                      <div class="img-box">
                        <img class="img-responsive" src="{{ asset('uploads/products/'.$data->images)}}" alt="img responsive">
                      </div>
                      <div class="img-slide">
                          ...
                          <div id="links">
                            @foreach($data->detail_img as $row)
                              <a href="{{ asset('uploads/products/details/'.$row->images_url)}}" title="{!!$data->name}}" data-gallery>
                                  <img src="{{ asset('uploads/products/details/'.$row->images_url)}}" alt="ả{!!$data->name}}" width="30" height="40">
                              </a>
                            @endforeach                              
                          </div>
                  ...
                  <div class="table-responsive">
                    <div class="panel panel-default">        
                      ...
                      <div id="links">
                           @foreach($data->detail_img as $row)
                              <a href="{{ asset('uploads/products/details/'.$row->images_url)}}" title="{!!$data->name}}" data-gallery>
                                  <img src="{{ asset('uploads/products/details/'.$row->images_url)}}" alt="ả{!!$data->name}}" width="23%" height="50%">
                              </a>
                            @endforeach
                      </div>
                        <!-- The Bootstrap Image Gallery lightbox, should be a child element of the document body -->
        ...
        @foreach($lap as  $row)
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">           
            <div class="thumbnail">          
              ...
              <div class="tomtat">
                <div class="thongtin">
                  <a href="{{ asset('laptop/'.$row->id.'-'.$row->slug)}}" title="">
                  <span class="label label-info ">Ưu đãi khi mua</span>   
                  @if ($row->promo1!='')
                    <li><span class="glyphicon glyphicon-ok-sign"></span>{!!$row->promo1}}</li>
                  @elseif($row->promo2!='')
                  ...
                  <div class="price">  
                    ...
                    <a href="{{ asset('gio-hang/addcart/'.$row->id)}}" class="btn btn-success btn-block">Thêm vào giỏ</a>                  
                  </div>                  
              </div> 
