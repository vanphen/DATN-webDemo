            ...
            <div class="panel-body">
              ...
              <!-- hot new content -->
                <div class="col-lg-12">
                  ...
                  <img class="img-new" src="{{ asset('uploads/news/'.$data->images)}}" alt="{!!$data->images}}" >                  
                ...
                @foreach($data as $row)
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                      <a href="{{ asset('/tin-tuc/'.$row->id.'-'.$row->slug)}}" title="{!!$row->title}}"><img src="{{ asset('uploads/news/'.$row->images)}}" alt="{!!$row->title}}" width="90%" height="99%"> </a>
                    </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
            <div class="thumbnail mobile">              
              ...
              <div class="ct">
                ...
                <a href="{{ asset('goa-hang')}}" class="btn btn-success pull-right add">Thêm vào giỏ </a>
            </div> <!-- / div thumbnail -->
          </div>  <!-- /div col-4 -->
        @endforeach        
