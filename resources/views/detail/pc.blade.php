...
@section('content')
    ...
    <h3 class="panel-title">
      ...
      <span class="glyphicon glyphicon-chevron-right" style="font-size: 11px;"></span><a href="{{ asset('/pc')}}" title=""> Máy tính bàn (PC)</a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                      <div class="img-box">
                        <img class="img-responsive img-mobile" src="{{ asset('uploads/products/'.$data->images)}}" alt="{!!$data->name}}">
                      </div>
                      <div class="img-slide">
