 <!-- main menu  navbar -->
        ...
        <div class="row">
          ...
          <div class="collapse navbar-collapse" id="main-mav-top">
            <ul class="nav navbar-nav">
              <li> <a href="{{ asset('')}}" title="" style="color: #FFFFFF;background-color: #2c3e50;"><b class="glyphicon glyphicon-home"></b> Trang chủ </a> </li>
              <li>
                <a href="{{ asset('mobile')}}" >Điện Thoại </a>                          
              </li>                                                  
              <li >
                <a href="{{ asset('laptop')}}" > Laptop </a>                
              </li>    
              <li>
                <a href="{{ asset('pc')}}" > Máy Tính </a>                
              </li>                                          
              <li>
               <a href="{{ asset('tin-tuc')}}" > Tin Tức - Khuyễn Mãi </a>                    
              </li>                                            
            </ul>
                  ...
                  <div class="table-responsive">
                     <table class="table table-hover" >
                      ...
                      @foreach(Cart::content() as $row)
                         <tr>
                           <td> {!!$row->images}} <img class="card-img img-circle" src="{{ asset('uploads/products/'.$row->options->img)}}" alt="dell"></td>
                           <td>{!!$row->qty}}</td>
                           <td>{!!$row->name}}</td>                           
                           <td>{!!$row->price}} Vnd</td>
                         </tr>                         
                     ...
                     <a href="{{ asset('/gio-hang/')}}" type="button" class="btn btn-success"> Chi Tiết Giỏ Hàng </a>
                     <a href="{{ asset('/gio-hang/xoa')}}" type="button" class="btn btn-danger pull-right"> Xóa </a>
                  </div>
                  @else
                    <div class="table-responsive">
                     <table class="table table-hover" >
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="{{ asset('gio-hang')}}"> <span class="glyphicon glyphicon-shopping-cart"><span class="badge">{!!Cart::count()}}</span></span> Giỏ Hàng </a>     
  </div>
  <!-- /left slider bar nav -->
  ...
  <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      ...
      <div class="loginmodal-container">
        ...
        <div class="login-help">
          <a class="btn btn-link" href="{{ asset('/register')}}"> <strong style="color:red;"> Đăng ký </strong> </a> - <a class="btn btn-link" href="{{ url('/password/reset') }}">Bạn đã quên mật khẩu?</a>
        </div>
      </div>
    </div>
  </div>