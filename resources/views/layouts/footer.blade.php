    ...
    <script type='text/javascript' src='{{ asset('js/active-menu.js') }}'></script> 
    <script src="https://cdnjs.cloudflare.com/ajax/libs/simple-gallery-js/1.0.3/simple-gallery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/blueimp-gallery/3.1.1/js/blueimp-gallery-fullscreen.js"></script>
