        ...
        @foreach($mobile as $row)        
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding">
            <div class="thumbnail mobile">              
              ...
              <div class="ct">
                <a href="{{ asset('mobile/'.$row->id.'-'.$row->slug)}}" title="Xem chi tiết">
        ...
        <!--========================== phan danh muc laptop   =========================================  -->
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding" >
            <div class="thumbnail">          
              ...
              <div class="tomtat">
                <div class="thongtin">
                  <a href="{{ asset('laptop/'.$row->id.'-'.$row->slug)}}" title="Xem chi tiết">
                    <span class="label label-info ">Ưu đãi khi mua</span>   
                    <li><span class="glyphicon glyphicon-hand-right"></span> {!!$row->promo1}}</li> 
        ...
        @foreach($pc as $row)
           <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding">
            <div class="thumbnail pc">              
              ...
              <div class="ct">
                <a href="{{ asset('pc/'.$row->id.'-'.$row->slug)}}" title="Xem chi tiết">                   
